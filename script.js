...
const dispRecipe=async(meal)=>{
    ...
    infoMeal.className='bg-red-500 hover:bg-pink-600 trainsition-all border-2 md:border-4 z-50 w-full h-max rounded-xl shadow-lg p-6 lg:p-10 relative'
...
const displayCategories=(category)=>{
    ...
    catItem.className=' py-4 rounded-lg shadow-lg md:w-44 w-32 text-center cursor-pointer mt-4 bg-pink-500 border-2 transition-all  scale hover:bg-yellow-600'
    catItem.id = 'category'
